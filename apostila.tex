...
\date{\bf \sffamily \large circa 2009}
...
\section{Controle de Fluxo}
	...
	Controle de fluxo \'e a habilidade de ajustar a maneira como um programa realiza suas tarefas. Por meio de instruções especiais, chamadas comandos, essas tarefas podem ser executadas seletivamente ou repetidamente.
...
%sinal = 1 se num é positivo
%sinal = -1 se num é negativo
%sinal = 0 se num = 0
...
\end{verbatim}
	...
	Lembre-se que á fun\c{c}\~ao {\tt eh\_par} foi usado como um exemplo anterior para mostrar como trabalhar com a estrutura {\tt if-else}.
